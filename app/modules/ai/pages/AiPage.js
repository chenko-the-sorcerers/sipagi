...
function renderAiContent() {
    ...
    if (!root) return;
    if (pageState.loading) { root.innerHTML = LoadingCard({ title: 'Memuat AI Assistant dari Data', text: 'Mengambil run, rekomendasi, anomali, dan konteks data...' }); return; }
...
export function initAiPage(initialView = 'runs') {
    pageState.activeView = views.some((view) => view.id === initialView) ? initialView : 'runs';

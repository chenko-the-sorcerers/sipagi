...
function renderActionBar() {
    return `
        <div class="inventory-action-bar">
            <button class="erp-btn primary" data-action="refresh-operational" type="button">Refresh GAS</button>
...
function renderOperationalContent() {
    ...
    if (pageState.loading) {
        root.innerHTML = '<div class="erp-card inventory-loading"><h3>Memuat Operasional dari GAS</h3><p class="erp-muted">Mengambil resep, produksi, packing, distribusi, dan checklist...</p></div>';
        return;
    }
...
export function initOperationalPage() {
    if (!eventsBound) {
